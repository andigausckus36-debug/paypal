import React from 'react'; import Calculadora from '../components/Calculadora'; import ContactForm from '../components/ContactForm'; import ReseñasFB from '../components/Reseñas'; import ContadorTransacciones from '../components/ContadorTransacciones';

export default function Inicio() { const imagenes = [ "https://i.postimg.cc/KjNWhs2t/Screenshot-20251011-132641-Whats-App.jpg", "https://i.postimg.cc/XY78pcRP/IMG-20251006-WA0371.jpg", "https://i.postimg.cc/J47Jq7pP/IMG-20251007-WA0525.jpg", ];

return ( <div id="inicio" className="min-h-screen bg-gray-50 flex flex-col items-center p-4 font-sans">

{/* Encabezado */}
  <header className="text-center mb-8 mt-6">

    <p className="text-4xl md:text-2xl font-medium text-gray-600 mb-12 mt-2 max-w-2xl mx-auto">
      ¡Compra y vende tu saldo PayPal de forma simple y segura con la mejor cotización y un tiempo récord de 10 a 30 minutos en todas las operaciones!
    </p>
  ...
  <section className="w-full bg-gradient-to-r from-blue-100 via-blue-50 to-blue-100 p-6 md:p-10 rounded-xl shadow-lg max-w-4xl mx-auto">
    <div className="grid md:grid-cols-3 gap-6 text-center">
      ...
      <div className="bg-white rounded-xl shadow-md p-6 flex flex-col items-center">
        ...
        <p className="text-sm text-gray-600 mt-2">Seleccioná si querés comprar o vender saldo PayPal y escribí el monto.</p>
      </div>

      <div className="bg-white rounded-xl shadow-md p-6 flex flex-col items-center">
        <div className="text-3xl font-bold text-primary mb-2">2</div>
        <h3 className="font-semibold text-lg">Completá tus datos</h3>
        <p className="text-sm text-gray-600 mt-2">Ingresá tu nombre y apellido, email de PayPal, WhatsApp, CBU / CVU y Banco o billetera.</p>
      </div>

      <div className="bg-white rounded-xl shadow-md p-6 flex flex-col items-center">
        <div className="text-3xl font-bold text-primary mb-2">3</div>
        <h3 className="font-semibold text-lg">Envianos tu pedido</h3>
        <p className="text-sm text-gray-600 mt-2">Te abrimos un chat de WhatsApp con los datos prellenados para confirmar la operación.</p>
      </div>
